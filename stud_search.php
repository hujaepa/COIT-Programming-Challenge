     ...
     <li></li>
      ...
      <form class="navbar-form navbar-left" role="search" id="search_form" action="" method="get">
        <div class="form-group">
          <input type="text" class="form-control" id="searchval" name="value" placeholder="Enter problem title">&nbsp;
          <button><img src="image/searchblue.png" width="30px" height="30px" id="search" name="test"></button>
        </div>
      </form>
...
<script type="text/javascript">alert("Please Enter the keyword");</script>
<?php
...
echo "<tr><td><a href='stud_view_specific.php?name=".$row['setname']."'>".$row['setname']."</a></td><td> <a href='view_lect_profile.php?id=".$row['lect_id']."'>".$row['first_name']." ".$row['last_name']
