...
where problem_set.set_name='$title' and answer.status='success' and not student.stud_username='$username' order by answer.date_time_submit desc";
...
$symbol="wrong.png";
echo "<tr>
<td>".$row['stud_first_name']." ".$row['stud_last_name']."
...
//no data
	...
	echo "<br/><h3><i>No other student successful submission has been made<i></h3>";
}
