...
FROM problem_set
INNER JOIN lecturer ON problem_set.lect_id = lecturer.lect_id where problem_set.set_level='easy' order by created desc ";
...
."</td><td>".$row['level']."</td><td>".$row['created']."</td></tr>";
 ...
 echo "No easy problem set has created";
