...
<nav class="navbar navbar-inverse navbar-fixed-top navbar-center-lecturer" role="navigation">
  ...
  <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><img src=<?php echo "../image/$image"?> class="rounder padding_1"><?php  //echo "<img src='../image/$image' class='rounder padding_1' />";?></li>
       <li><div class="pad-menu"><?php echo "Welcome $name";?></span></div></li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="divider"></li>
            <li><a href="#">View created problem set</a></li>
            <li class="divider"></li>
